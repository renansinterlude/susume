...
useEffect(() => {
  document.title = "Susume | JLPT N2 - Kanji";
}, []);

useEffect(() => {
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://localhost:3000/kanjiN2?page=${currentPage}`);
...
const renderPageButtons = () => {
  ...
  return (
    <div>
      <Cabecalho />
      <h1 className="tituloVerbo"> JLPT N2 - Kanji </h1>
      <p className="textoVerbo"> Para o nível N1 são considerados 367 kanjis como conhecimento básico. </p>
                  ...
                  >
                    <Typography>
                      ...
                      <strong>
                        ...
                        <br />
                        <Link to={`/jlpt-n2/detalhes-palavra-kanji/${vocabulary.Kanji}`}>
