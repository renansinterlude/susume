...
useEffect(() => {
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://localhost:3000/kanjiN3?page=${currentPage}`);
...
const renderPageButtons = () => {
  ...
  return (
    <div>
      <Cabecalho />
      <h1 className="tituloVerbo"> JLPT N3 - Kanji </h1>
                  ...
                  >
                    <Typography>
                      ...
                      <strong>
                        ...
                        <br />
                        <Link to={`/jlpt-n3/detalhes-palavra-kanji/${vocabulary.Kanji}`}>
