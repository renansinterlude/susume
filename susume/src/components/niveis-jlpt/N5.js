            ...
            <Cabecalho />
                <div className="container-conteudo">
                    <div className="container-jlpt-50">
                        <h1 className="titulo"> JLPT N5 </h1>
                        ...
                        <div className="container-jlpt-tipo">
                            <Link to="/jlpt-n5-kanji" className="link-sem-sublinhado">
                            <div className="tipo-estudo cor-kanji"> <p className="texto-tipo-estudo"> KANJI </p> </div>
                            </Link>
                            <Link to="/jlpt-n5-vocabulario" className="link-sem-sublinhado">
