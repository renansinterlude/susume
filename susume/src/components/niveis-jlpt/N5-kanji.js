...
useEffect(() => {
  document.title = "Susume | JLPT N5 - Kanji";
}, []);

useEffect(() => {
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://localhost:3000/kanjiN5?page=${currentPage}`);
...
const renderPageButtons = () => {
  ...
  return (
    <div>
      <Cabecalho />
      <h1 className="tituloVerbo"> JLPT N5 - Kanji </h1>
      <p className="textoVerbo"> Para o nível N5 são considerados 80 kanjis como conhecimento básico. </p>
                  ...
                  >
                    <Typography>
                      ...
                      <strong>
                        ...
                        <br />
                        <Link to={`/jlpt-n5/detalhes-palavra-kanji/${vocabulary.Kanji}`}>
