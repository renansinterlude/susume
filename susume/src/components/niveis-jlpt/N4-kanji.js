...
useEffect(() => {
  document.title = "Susume | JLPT N4 - Kanji";
}, []);

useEffect(() => {
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://localhost:3000/kanjiN4?page=${currentPage}`);
...
const renderPageButtons = () => {
  ...
  return (
    <div>
      <Cabecalho />
      <h1 className="tituloVerbo"> JLPT N4 - Kanji </h1>
      <p className="textoVerbo"> Para o nível N4 são considerados 167 kanjis como conhecimento básico. </p>
                  ...
                  >
                    <Typography>
                      ...
                      <strong>
                        ...
                        <br />
                        <Link to={`/jlpt-n4/detalhes-palavra-kanji/${vocabulary.Kanji}`}>
