...
const totalPages = 25; // Número total de páginas
...
useEffect(() => {
  document.title = "Susume | JLPT N1 - Kanji";
}, []);

useEffect(() => {
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://localhost:3000/kanjiN1?page=${currentPage}`);
...
const renderPageButtons = () => {
  ...
  return (
    <div>
      <Cabecalho />
      <h1 className="tituloVerbo"> JLPT N1 - Kanji </h1>
      <p className="textoVerbo"> Para o nível N1 são considerados 615 kanjis como conhecimento básico. </p>
            ...
            <div className="containerAccordion">
              ...
              <div className="displayAccordion">
                <Accordion elevation={0} className='accordionLargura'>
                  ...
                  >
                    <Typography>
                      <p className='kanji-vocabulario'>{vocabulary.Kanji}</p>
                    </Typography>
                  </AccordionSummary>
                  <AccordionDetails sx={{
                      backgroundColor: "#f2e6d8"
                  ...
                  >
                    <Typography>
                      ...
                      <strong>
                        ...
                        <p>Leitura On - {vocabulary["On-Reading"]}</p>
                        <p>Leitura Kun - {vocabulary["Kun-Reading"]}</p>
                        <br />
                        <Link to={`/jlpt-n1/detalhes-palavra-kanji/${vocabulary.Kanji}`}>
