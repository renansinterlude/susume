...
useEffect(() => {
  const fetchData = async () => {
    try {
      const response = await axios.get(`http://localhost:3000/vocabularioN4?page=${currentPage}`);
...
const renderPageButtons = () => {
  ...
  return (
    <div>
      <Cabecalho />
      <h1 className="tituloVerbo"> JLPT N4 - Vocabulário </h1>
                    ...
                    <Typography>
                      ...
                      <strong>
                        ...
                        {vocabulary["Word-Type"].includes("Verbo") ? (
                          ...
                          <Link to={`/jlpt-n4/detalhes-palavra/${vocabulary.Vocabulary}`}>
